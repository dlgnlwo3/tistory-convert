...
# pyinstaller -n "tistory convert v0.0.8" -w --onefile --clean "main.py" --icon "assets\tistory.ico" --add-data "venv/Lib/site-packages/newspaper;newspaper"
# pyinstaller -n "tistory convert v0.0.8" -w --onefile --clean "D:\Consolework\tistory-convert-new\main.py" --icon "D:\Consolework\tistory-convert-new\assets\tistory.ico" --add-data "venv/Lib/site-packages/newspaper;newspaper"
